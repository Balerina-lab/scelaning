...
function BookingForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      {/* Service Details */}
      <div>
        <h3 className="text-lg font-extrabold text-navy-500 mb-4 flex items-center gap-2">
          <span className="w-7 h-7 bg-teal-400 text-white rounded-lg flex items-center justify-center text-xs font-black">1</span>
      ...
      <div>
        <h3 className="text-lg font-extrabold text-navy-500 mb-4 flex items-center gap-2">
          <span className="w-7 h-7 bg-teal-400 text-white rounded-lg flex items-center justify-center text-xs font-black">2</span>
          Datum in čas
        </h3>
      ...
      <div>
        <h3 className="text-lg font-extrabold text-navy-500 mb-4 flex items-center gap-2">
          <span className="w-7 h-7 bg-teal-400 text-white rounded-lg flex items-center justify-center text-xs font-black">3</span>
          Vaši podatki
        </h3>
      ...
      <div>
        <h3 className="text-lg font-extrabold text-navy-500 mb-4 flex items-center gap-2">
          <span className="w-7 h-7 bg-teal-400 text-white rounded-lg flex items-center justify-center text-xs font-black">4</span>
          Posebne zahteve
        </h3>
        <textarea
          rows={4}
